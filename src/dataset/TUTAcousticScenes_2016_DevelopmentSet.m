classdef TUTAcousticScenes_2016_DevelopmentSet < DatasetBase
    ...
    methods
        function obj = TUTAcousticScenes_2016_DevelopmentSet(data_path, proto)
            if nargin < 2 || isempty(proto)
                proto = 'https';
            end

            if ~any(strcmp(proto, {'http', [proto '']}))
            ...
            obj.url = [proto '://zenodo.org/record/45739'];
            ...
            obj.package_list = [
                ...
                struct('remote_package',[proto '://zenodo.org/record/45739/files/TUT-acoustic-scenes-2016-development.doc.zip'],...
                       'local_package',fullfile(obj.local_path, 'TUT-acoustic-scenes-2016-development.doc.zip'),...
                       'local_audio_path',fullfile(obj.local_path, 'audio')),
                struct('remote_package',[proto '://zenodo.org/record/45739/files/TUT-acoustic-scenes-2016-development.meta.zip'],...
                       'local_package',fullfile(obj.local_path, 'TUT-acoustic-scenes-2016-development.meta.zip'),...
                       'local_audio_path',fullfile(obj.local_path, 'audio')),                       
                struct('remote_package',[proto '://zenodo.org/record/45739/files/TUT-acoustic-scenes-2016-development.audio.1.zip'],...
                       'local_package',fullfile(obj.local_path, 'TUT-acoustic-scenes-2016-development.audio.1.zip'),...
                       'local_audio_path',fullfile(obj.local_path, 'audio')),                                              
                struct('remote_package',[proto '://zenodo.org/record/45739/files/TUT-acoustic-scenes-2016-development.audio.2.zip'],...
                       'local_package',fullfile(obj.local_path, 'TUT-acoustic-scenes-2016-development.audio.2.zip'),...
                       'local_audio_path',fullfile(obj.local_path, 'audio')),                                                                     
                struct('remote_package',[proto '://zenodo.org/record/45739/files/TUT-acoustic-scenes-2016-development.audio.3.zip'],...
                       'local_package',fullfile(obj.local_path, 'TUT-acoustic-scenes-2016-development.audio.3.zip'),...
                       'local_audio_path',fullfile(obj.local_path, 'audio')),                                                                     
                struct('remote_package',[proto '://zenodo.org/record/45739/files/TUT-acoustic-scenes-2016-development.audio.4.zip'],...
                       'local_package',fullfile(obj.local_path, 'TUT-acoustic-scenes-2016-development.audio.4.zip'),...
                       'local_audio_path',fullfile(obj.local_path, 'audio')),                                                                     
                struct('remote_package',[proto '://zenodo.org/record/45739/files/TUT-acoustic-scenes-2016-development.audio.5.zip'],...
                       'local_package',fullfile(obj.local_path, 'TUT-acoustic-scenes-2016-development.audio.5.zip'),...
                       'local_audio_path',fullfile(obj.local_path, 'audio')),                                                                     
                struct('remote_package',[proto '://zenodo.org/record/45739/files/TUT-acoustic-scenes-2016-development.audio.6.zip'],...
                       'local_package',fullfile(obj.local_path, 'TUT-acoustic-scenes-2016-development.audio.6.zip'),...
                       'local_audio_path',fullfile(obj.local_path, 'audio')),      
                struct('remote_package',[proto '://zenodo.org/record/45739/files/TUT-acoustic-scenes-2016-development.audio.7.zip'],...
                       'local_package',fullfile(obj.local_path, 'TUT-acoustic-scenes-2016-development.audio.7.zip'),...
                       'local_audio_path',fullfile(obj.local_path, 'audio')),      
                struct('remote_package',[proto '://zenodo.org/record/45739/files/TUT-acoustic-scenes-2016-development.audio.8.zip'],...
